...
function colorDifference(c1, c2) {
	switch (cs) {
		...
		case "CIELUV" :
			...
			break;
		case "LRGB" :
			return LRGBColorDifference(c1, c2);
			break;
	}
}
...
function LRGBColorDifference(c1, c2) {
	var d = 0;
	d = Math.sqrt(Math.pow((c1.r-c2.r),2)+Math.pow((c1.g-c2.g),2)+Math.pow((c1.b-c2.b),2));
	return d;
}
